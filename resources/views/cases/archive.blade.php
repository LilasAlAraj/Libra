...
<body>
                    ...
                    <div id="big-frame">
                        ...
                        <div class="container">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <div id="searchByTitleTabAuth">

                                </div>


                                <div id="searchByBaseNumberTabAuth">

                                </div>

                                <div id="searchByStatusTabAuth">

                                </div>

                                <div id="searchByCourtTabAuth">

                                </div>


                                <div id="searchByPlaintaiffNameTabAuth">

                                </div>


                                <div id="searchByLawyerNameTabAuth">

                                </div>

                                <div id="searchByYearsTabAuth">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="height: fit-content; ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer " style="width:auto;">
                        <button type="submit" id="cancelArchivingBtn" class="operations-btn btn btn-warning">
        ...
        <div class="modal fade" id="deleteCaseBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="height: fit-content; ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer " style="width:auto;">
                        <button type="submit" id="deleteArchivedCaseBtn" class="operations-btn btn btn-danger">
                            <span data-feather="archive" class="align-text-bottom"></span>
                            احذف
                        </button>
                        <button type="button" class="btn btn-dark" data-bs-dismiss="modal" onclick="closeModal()">
    ...
    <script src="../../js/cases/archive.js"></script>
