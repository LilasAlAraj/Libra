                            ...
                            <div class="container">
                                <div class="row ">
                                    <div class="col-4">
                                        ...
                                        <input type="text" id="case_tiltle" placeholder="أدخل موضوع الدعوى"
                                            name="case_tiltle" required>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" id="case_room" placeholder="أدخل اسم الغرفة"
                                            name="case_room" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container frame ">
                                ...
                                <div class="container">
                                    <div class="row d-flex justify-content-evenly">
                                        ...
                                        <button id="del_base_number" onclick="deleteBaseNumberField()"
                                            type="button">
                                    ...
                                    <div class=" col-12" style="height:  100%;">
                                        ...
                                        <div class="row ">
                                            <div class=" col-6 frame">
                                                ...
                                                <div class="container">
                                                    <div class="row d-flex  justify-content-evenly">
                                                        ...
                                                        <button id="client-pls-vs1"
                                                            onclick="addClientPlaintiffField()" type="button">
                                                            <span data-feather="plus"
                                                                class="align-text-bottom "></span>

                                                        </button>

                                                        <button id="client-delete-vs1"
                                                            onclick="deleteClientPlaintiffField()" type="button">
                                            ...
                                            <div class=" col-6 frame">
                                                ...
                                                <div class="container">
                                                    <div class="row d-flex  justify-content-evenly">
                                                        <button id="lawyer-pls-vs1"
                                                            onclick="addLawyerPlaintiffField()" type="button">
                                                            <span data-feather="plus"
                                                                class="align-text-bottom "></span>
                                                        </button>
                                                        <button id="lawyer-delete-vs1"
                                                            onclick="deleteLawyerPlaintiffField()" type="button">
                                                            <span data-feather="minus"
                                                                class="align-text-bottom "></span>
                                                        </button>
                                                    </div>
                                    ...
                                    <div class=" col-12">
                                        ...
                                        <div class="row ">
                                            <div class=" col-6 frame">
                                                ...
                                                <div class="container">
                                                    <div class="row d-flex  justify-content-evenly">
                                                        <button id="client-pls-vs2" onclick="addClientEnemyField()"
                                                            type="button">
                                                            <span data-feather="plus"
                                                                class="align-text-bottom "></span>

                                                        </button>
                                                        <button id="client-delete-vs2"
                                                            onclick="deleteClientEnemyField()" type="button">
                                                            <span data-feather="minus"
                                                                class="align-text-bottom "></span>
                                                        </button>
                                                    </div>
                                            ...
                                            <div class=" col-6 frame">
                                                ...
                                                <div class="container">
                                                    <div class="row d-flex  justify-content-evenly">
                                                        <button id="lawyer-pls-vs2" onclick="addLawyerEnemyField()"
                                                            type="button">
                                                            <span data-feather="plus"
                                                                class="align-text-bottom "></span>

                                                        </button>
                                                        <button id="lawyer-delete-vs2"
                                                            onclick="deleteLawyerEnemyField()" type="button">
                                                            <span data-feather="minus"
                                                                class="align-text-bottom "></span>
                                                        </button>
                                                    </div>
