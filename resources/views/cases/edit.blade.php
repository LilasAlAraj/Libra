                                ...
                                <div class=" col-12" style="height:  100%;">
                                    ...
                                    <div class="row ">
                                        <div class=" col-6 frame">
                                            ...
                                            <div class="container">
                                                <div class="row d-flex  justify-content-evenly">
                                                    ...
                                                    <button id="client-pls-vs1" onclick="addClientPlaintiffField()"
                                                        type="button">
                                                        <span data-feather="plus" class="align-text-bottom "></span>
                                        ...
                                        <div class=" col-6 frame">
                                            ...
                                            <div class="container">
                                                <div class="row d-flex  justify-content-evenly">
                                                    <button id="lawyer-pls-vs1" onclick="addLawyerPlaintiffField()"
                                                        type="button">
                                                        <span data-feather="plus" class="align-text-bottom "></span>
                                                    </button>
                                        ...
                                        <div class=" col-6 frame">
                                            ...
                                            <div class="container">
                                                <div class="row d-flex  justify-content-evenly">
                                                    ...
                                                    <button id="client-delete-vs2" onclick="deleteClientEnemyField()"
                                                        type="button">
                                                        <span data-feather="minus" class="align-text-bottom "></span>
                                                    </button>
                                                </div>
                                        ...
                                        <div class=" col-6 frame">
                                            ...
                                            <div class="container">
                                                <div class="row d-flex  justify-content-evenly">
                                                    ...
                                                    <button id="lawyer-delete-vs2" onclick="deleteLawyerEnemyField()"
                                                        type="button">
                                                        <span data-feather="minus" class="align-text-bottom "></span>
                                                    </button>
                                                </div>
