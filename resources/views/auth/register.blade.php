            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="mother_name" class="col-md-4 col-form-label text-md-end">{{ __('mother_name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="current_address" class="col-md-4 col-form-label text-md-end">{{ __('current_address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="place_of_birth" class="col-md-4 col-form-label text-md-end">{{ __('place_of_birth') }}</label>
