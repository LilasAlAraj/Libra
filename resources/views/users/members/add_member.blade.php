                        ...
                        <div class="container">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="password" id="confirm_password" placeholder="أكّد كلمة المرور"
                                        name="confirm_password" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-check col-6" style="width: fit-content;">
                                    <input class="form-check-input" type="radio" name="rule" id="seretaria"
                                        value="سكرتاريا">
                                ...
                                <div class="form-check col-6 " style="width: fit-content;">
                                    <input class="form-check-input" type="radio" name="rule" id="lawyer"
                                        value="محامي">
