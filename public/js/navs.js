...
function setCaseNavAuth(dots) {
    ...
    if (role == 1 || role == 2) {
        ...
        document.getElementById('addNewCaseNav').innerHTML = '<a href="http://127.0.0.1:8000/cases/create" class="nav-link d-inline-flex collapse-items L-Affiliate-Tagged">'
        ...
        document.getElementById('archiveCaseNav').innerHTML = '<a href="http://127.0.0.1:8000/cases/archive" class="nav-link d-inline-flex collapse-items L-Affiliate-Tagged">'
