...
function setNumPrivateCases() {

  let num_priv_cases = 10;
  ...
  /*
      ...
      $.ajax({
          ...
          success: function (response) {
              num_priv_cases = response.data.num_priv_cases;
          },
  ...
  */
  document.getElementById('num_priv_cases').innerHTML = num_priv_cases;
}
